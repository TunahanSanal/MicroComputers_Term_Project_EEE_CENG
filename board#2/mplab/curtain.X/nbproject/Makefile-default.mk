...
FINAL_IMAGE=${DISTDIR}/curtain.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=curtain.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/curtain.o
POSSIBLE_DEPFILES=${OBJECTDIR}/curtain.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/curtain.o

# Source Files
SOURCEFILES=curtain.s
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/curtain.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC16F877A
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/curtain.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/curtain.o: curtain.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/curtain.o 
	${MP_AS} -mcpu=PIC16F877A -c \
	-o ${OBJECTDIR}/curtain.o \
	curtain.s \
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/curtain.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC16F877A ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/curtain.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
